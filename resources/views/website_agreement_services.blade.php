                    ...
                    <div class="col-md-12">
                        <div class="nav-top-static">
                            <ol class="breadcrumb" style="text-align:left">
                                ...
                                <li class="active"><a style = "color:#909090 !important;"> Website Agreements </a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ins-rcb-container-block">
                                <h1>  Get ahead, get started! </h1>
                                    ...
                                    <ul class="rcb-business-name">
                                        <li>Terms and Conditions I Privacy Policy  </li>
                                    </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12 col-md-push-8 col-sm-push-7 col-xs-push-0">
                        ...
                        <div class="ins-request-call-back-form2">
                            <div class="panel-heading">
                                <span class="pricely-label mobile-view-title">Website Agreements</span>
                                <div class="pricely-figure">
                                    <span class="pricely-currency"><i class="fa fa-rupee"></i></span>
                                    <span class="pricely-amount">12,000</span>
                        ...
                        <div class="pricely-chart2 plcrs-blk">
                            <div class="plan-block">
                                <div class="plan-inner-block">
                                    <h3>Website Agreements</h3>
                                    <div class="plan-discription">
                                        <h4>Services included:</h4>
                                        <ul>
                                        <li>
                                                            <i class="ion-checkmark-round"></i> Drafting of Terms &amp; Conditions and Privacy Policy of ONE website, or                                             </li>
                                        <li>
                                                            <i class="ion-checkmark-round"></i> Drafting of Terms &amp; Conditions and Privacy Policy of ONE mobile application                                            </li>
                                        <li>
                                                            <i class="ion-checkmark-round"></i> Dedicated advocate support                                            </li>
                                        </ul>
                                    </div>
                                    <div class="plan-discription">
                                        <h4>Ideal For:</h4>
                                        <ul>
                                                                <li>
                                                                                    <i class="ion-arrow-right-b"></i>  Ideal for companies and individuals interested in selling their goods and services online through their fully functional website or,
                                                                </li>
                                                                <li>
                                                                                    <i class="ion-arrow-right-b"></i>  Fully functional mobile application with the website for informational purposes only
                                                                </li>
                                        </ul>
                                    </div>
