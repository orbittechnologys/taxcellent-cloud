                        ...
                        <div class="col-md-12">
                            <div class="nav-top-static">
                                ...
                                li><a href="{{ url('/') }}">Home</a></li>
                                    ...
                                    <li><a href="{{ url('compliances-service') }}"> Compliance</a></li>
                                    <li class="active"><a style = "color:#909090 !important;"> Import Export Code </a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ins-rcb-container-block">
                                    <h1> Trust us with your application for statutory registration </h1>
                                        <h2>
                                            <span> We take care of the small things so that you can focus on the big picture </span>
                                        </h2>
                                        <ul class="rcb-business-name">
                                            <li>Mandatory for persons involved in : International trade l Export l Import l <br> Business of selling goods or services to international markets  </li>
                                        </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-5 col-xs-12 col-md-push-8 col-sm-push-7 col-xs-push-0">
                            ...
                            <input type="hidden" id="sub_cat_id" value="8" name="sub_cat_id">
                            <input type="hidden" id="serPrice" value="3598" name="serPrice">
                            <div class="ins-request-call-back-form2">
                                <div class="panel-heading">
                                    <span class="pricely-label mobile-view-title">Import Export Code</span>
                                    <div class="pricely-figure">
                                        <span class="pricely-currency"><i class="fa fa-rupee"></i></span>
                                        <span class="pricely-amount">3,598</span>
                                ...
                                <div class="plan-block">
                                    <div class="plan-inner-block">
                                        ...
                                        <div class="plan-discription">
                                            ...
                                            <ul>
                                            <li>
                                                <i class="ion-checkmark-round"></i> Advisory on registration requirement                                            </li>
                                            <li>
                                                <i class="ion-checkmark-round"></i> Preparation of application form                                            </li>
                                            <li>
                                                <i class="ion-checkmark-round"></i> Obtaining Import Export Code                                            </li>
                                            <li>
                                                <i class="ion-checkmark-round"></i> Documented Follow-up                                            </li>
                                            <li>
                                                <i class="ion-checkmark-round"></i> Dedicated CA                                            </li>
                                            </ul>
                                        </div>
                                        <div class="plan-discription">
                                            <h4>Ideal For:</h4>
                                            <ul>
                                                <li>
                                                    <i class="ion-arrow-right-b"></i>  Every exporter or importer of goods
                                                </li>
                                                <li>
                                                    <i class="ion-arrow-right-b"></i>  Service provider serving clients abroad
                                                </li>
                                            </ul>
                                        </div>
