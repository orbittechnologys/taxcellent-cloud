                        ...
                        <div class="col-md-12">
                            <div class="nav-top-static">
                                <ol class="breadcrumb" style="text-align:left">
                                    ...
                                    <li><a href='../itr-service.html'> Income Tax Return</a></li><li> Private Limited Company</li>
                                ...
                                <div class="pricely-chart pricely-professional">
                                    <section class="pricely-chart-section">
                                        <div class="pricely-pro-dview pricely-pro">
                                            <table class="table" id="plantable">
                                                <thead>
                                                        ...
                                                        <th class="pricely-first-heading panel-default colm-400">
                                                            <h3 class="panel-heading">
                                                                <p class="pricely-paragraph"><span class="planIcon ion-ios-paper"></span></p>
                                                                    <p class="pricely-foreword">Income Tax Return-Private Limited Company</p>
                                                            </h3>
                                                        </th>
                                                        <form method="POST" action="{{ route('cart.addToCart') }}">
                                                            <input type="hidden" id="service_id" value="6" name="serviceId">
                                                            <input type="hidden" id="sub_cat_id" value="17" name="sub_cat_id">
                                                            <input type="hidden" id="sub_cat_id" value="15" name="sub_pack_cat_id">
                                                            <input type="hidden" id="serPrice" value="3062" name="servicePrice">
                                                            @csrf
                                                        <th class="pricely-inner panel-NW-green1" id="th_Basic">
                                                            <h3 class="panel-heading">
                                                                ...
                                                                <div class="pricely-figure">
                                                                    ...
                                                                    <span class="pricely-amount">3,062</span>
                                                    ...
                                                    <input type="hidden" id="service_id" value="6" name="serviceId">
                                                    <input type="hidden" id="sub_cat_id" value="17" name="sub_cat_id">
                                                    <input type="hidden" id="sub_cat_id" value="16" name="sub_pack_cat_id">
                                                ...
                                                <tbody>
                                                    <tr class="list-group panle-heading2">
                                                        ...
                                                        <tr class="list-group">
                                                            <td class="list-group-item">
                                                                Private Limited Company with accurately created financial statements
                                                            </td>
                                                                <td class="list-group-item" id="td_Basic">
                                                                    <span class="planIcon ion-checkmark-round r"></span>
                                                                </td>
                                                        ...
                                                        <tr class="list-group">
                                                            <td class="list-group-item">
                                                                Private Limited Company without any financial statements
                                                            </td>
                                                            <td class="list-group-item" id="td_Basic">
                                                                <span class="planIcon ion-close-round x"></span>
                                                            </td>
                                                    ...
                                                    <div class="pricely-inner panel-NW-green1" id="th_Basic">
                                                        <h3 class="panel-heading">
                                                            ...
                                                            <div class="pricely-figure">
                                                                ...
                                                                <span class="per-return-text">per return</span>
                                                            <span class="pricely-button"><a href="javascript:;" id="46" class="btn btn-teal waves-effect waves-ripple buycartitem_withpackageclick">Buy plan</a></span>
                                                        </h3>
                                                    </div>
                                                    <ul class="list-group">
                                                        <li class="list-group-item"><strong> Services included:</strong></li>
                                                                        <li class="list-group-item">Filing of ITR 6 for Companies</li>
                                                            ...
                                                            <li class="list-group-item">  Private Limited Company with accurately created financial statements</li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="pricely-inner panel-NW-green1" id="th_Premium">
                                                        <h3 class="panel-heading">
                                                            ...
                                                            <div class="pricely-figure">
                                                                ...
                                                                <span class="per-return-text"> per return</span>
                                                            <span class="pricely-button"><a href="javascript:;" id=" 47" class="btn btn-teal waves-effect waves-ripple buycartitem_withpackageclick">Buy plan</a></span>
                                                        </h3>
                                                    </div>
                                                    <ul class="list-group">
                                                        <li class="list-group-item"><strong> Services included:</strong></li>
                                                        ...
                                                        <li class="list-group-item"><strong>Ideal for:</strong></li>
                                                        <li class="list-group-item">  Private Limited Company without any financial statements</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="dv-Disclaimer">
                                            <h4>Disclaimer</h4>
                                            <ul>
                                                <li class="asterisk">if you need clarification regarding the package that applies in your case, please write to <a href="../cdn-cgi/l/email-protection.html#3c55525a537c55524f485d5f5d125552"><span class="__cf_email__" data-cfemail="abc2c5cdc4ebc2c5d8dfcac8ca85c2c5">[email&#160;protected]</span></a></li>
