...
<div class="main-header sticky side-header nav nav-item">
    <div class="container-fluid">
        <div class="main-header-left ">
            ...
            <a href="{{ route('admin.home') }}"><img src="{{ asset('template/images/Taxcellent_Logo/AppIcons/playstore.png') }}" class="logo-2" alt="logo"></a>
            </div>
            ...
            <div class="nav nav-item  navbar-nav-right ms-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                ...
                                <div class="ms-3 my-auto">
                                    ...
                                    <span>
                                       @php $adminuser = Auth::guard('admin')->user()->is_super @endphp
                                        @if( $adminuser == 1 )
                                            Super Admin
                                        @endif
                                    </span>
                        ...
                        <a class="dropdown-item" href="{{route('admin.editprofile')}}"><i class="bx bx-cog"></i> Edit Profile</a>
