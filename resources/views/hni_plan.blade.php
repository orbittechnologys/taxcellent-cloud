                        ...
                        <div class="col-md-12">
                            <div class="nav-top-static">
                                <ol class="breadcrumb" style="text-align:left">
                                    ...
                                    <li><a href='../itr-service.html'> Income Tax Return</a></li>


                                    <li class="active"><a style = "color:#909090 !important;"> HNI Plan </a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 col-sm-5 col-xs-12 col-md-push-8 col-sm-push-7 col-xs-push-0">
                                ...
                                <input type="hidden" id="sub_cat_id" value="19" name="sub_cat_id">
                                <input type="hidden" id="serPrice" value="4499" name="serPrice">
                                <div class="ins-request-call-back-form2">
                                    <div class="panel-heading">
                                        <span class="pricely-label mobile-view-title">HNI Plan</span>
                                ...
                                <div class="pricely-chart2 plcrs-blk">
                                        ...
                                        <div class="plan-inner-block">
                                            ...
                                            <div class="plan-discription">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                                        <i class="ion-arrow-right-b"></i>  Individual with income above 50 lakh
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="dv-Disclaimer">
                                        ...
                                        <ul>
                                            ...
                                            <li class="asterisk">If you need clarification regarding the package that applies in your case, please write to <a href="../cdn-cgi/l/email-protection.html#d9b0b7bfb699b0b7aaadb8bab8f7b0b7"><span class="__cf_email__" data-cfemail="0c65626a634c65627f786d6f6d226562">[email&#160;protected]</span></a> with your details</li>
