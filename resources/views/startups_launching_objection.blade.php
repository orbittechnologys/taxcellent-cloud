    ...
    <div class="page-wrapper">           
                    ...
                    <div class="col-md-12">
                        <div class="nav-top-static">
                            ...
                            <li><a href="{{ url('/') }}">Home</a></li>
                                ...
                                <li class="active"><a style = "color:#909090 !important;"> Trademark Objection </a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ins-rcb-container-block">
                                <h1>  Get ahead, get started! </h1>
                                    ...
                                    <ul class="rcb-business-name">
                                        <li>Response to a Trademark objection  </li>
                                    </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-content">
            ...
            <div class="container">
                ...
                <input type="hidden" id="serPrice" value="3999" name="serPrice">
                <div class="row">
                    <div class="col-md-4 col-sm-5 col-xs-12 col-md-push-8 col-sm-push-7 col-xs-push-0">
                        
                        <div class="ins-request-call-back-form2">
                            <div class="panel-heading">
                                <span class="pricely-label mobile-view-title">Trademark Objection</span>
                            ...
                            <div class="plan-block">
                                <div class="plan-inner-block">
                                    ...
                                    <div class="plan-discription">
                                        ...
                                        <ul>
                                        <li>
                                            <i class="ion-checkmark-round"></i> Draft appropriate response to objection received
                                        </li>
                                        <li>
                                            <i class="ion-checkmark-round"></i> Submission of response to a Trademark objection
                                        </li>
                                        <li>
                                            <i class="ion-checkmark-round"></i> Advice on course of action
                                        </li>
                                        <li>
                                            <i class="ion-checkmark-round"></i> Dedicated advocate support
                                        </li>
                                        <li>
                                            <i class="ion-checkmark-round"></i> Package consists of response to one objection in one class only
                                        </li>
                                        </ul>
                                    </div>
                                    <div class="plan-discription">
                                        ...
                                        <ul>
                                            <li>
                                               <i class="ion-arrow-right-b"></i>  A Trademark applicant who has received an objection by the trademark examiner
                                            </li>
                                        </ul>
                                    </div>
                                </div>
